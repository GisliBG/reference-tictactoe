...
cp ~/gislibg-key-pair.pem /var/lib/jenkins/workspace/Commit\ Stage\ Job//Dockerfile ./build/
cp ~/gislibg-key-pair.pem /var/lib/jenkins/workspace/Commit\ Stage\ Job//migratescript.sh ./build/
